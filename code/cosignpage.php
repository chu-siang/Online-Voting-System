...
<body>
    ...
    <main>
        ...
        <div class="wrapper">
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<h2>" . htmlspecialchars($row["cosign_Number"]) . "</h2>";
        ...
        <form id="voteForm" action="submit_cosign.php" method="POST">
        ...
        <script>
            document.querySelectorAll('.cosign-image').forEach(img => {
                img.addEventListener('click', function() {
                    ...
                    window.location.href = 'cosign_details.php?candidate=' + encodeURIComponent(candidateName);
                });
            });
